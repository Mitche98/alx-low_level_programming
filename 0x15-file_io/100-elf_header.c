 ...
 * @e_ident: pointer to array containing ELF magic numbs
 *
 * Descp: if file is not ELF file, exit code 98
 */
void check_elf(unsigned char *e_ident)
{
	int start;
...
/**
 * print_magic - prints magic nums of ELF header
 * @e_ident: pointer to array containing ELF magic nums
 *
 * Desc: magic nums are seperated by spaces
 */
void print_magic(unsigned char *e_ident)
{
	int start;
 ...
 * @e_ident: pointer to array containing ELF header
 */
void print_class(unsigned char *e_ident)
{
	printf("  Class:       ");
 ...
 *
 * Desc: exit 98 if file cannot be closed
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
